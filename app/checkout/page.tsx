          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="bg-card border border-border rounded-lg p-6 space-y-4 mb-6">
              <div>
                ...
                <p className="text-lg font-bold text-foreground">#ORD-{orderPlaced && newOrder?.id}</p>
              </div>
              <div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4 mb-8">
              ...
              <div className="flex-grow flex items-center">
                <div className={`h-1 w-full ${step === 2 ? "bg-primary" : "bg-border"}`}></div>
              </div>
              <div
                className={`flex items-center justify-center w-10 h-10 rounded-full font-semibold ${
            ...
            {step === 1 && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input type="text" name="street" value={shippingInfo.street} onChange={handleInputChange} required />
                </div>
                ...
                <Button onClick={() => setStep(2)} disabled={!validateShippingInfo()} className="w-full" size="lg">
                  Continue to Payment
                </Button>
              </div>
            )}
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <Button variant="outline" onClick={() => setStep(1)} className="mt-4 w-full sm:w-auto">
                    Edit
                  </Button>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    This is a demo. In production, use Stripe or similar payment gateway.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Button variant="outline" onClick={() => setStep(1)} className="w-full" disabled={isProcessing}>
                    Back
                  </Button>
                </div>
              </div>
            ...
            <div className="bg-card border border-border rounded-lg p-6 sticky top-24 space-y-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-foreground">${tax.toLocaleString("en-US", { maximumFractionDigits: 2 })}</span>
                </div>
              </div>
